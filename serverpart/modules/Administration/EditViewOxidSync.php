...
$xtpl=new XTemplate('modules/Administration/EditViewOxidSync.html');
...
if ($sugar55){
    $xtpl->assign('h4class', "");   
    $xtpl->assign('tabForm', "edit view");   
  
}else{
    $xtpl->assign('h4class', "class=\"dataLabel\"");
    $xtpl->assign('tabForm', "tabForm");
}
